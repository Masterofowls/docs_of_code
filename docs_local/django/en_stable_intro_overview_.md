...
Source: https://docs.djangoproject.com/en/stable/intro/overview/
...
reference – but we’ve got both! When you’re ready to start a project, you can
 start with the tutorial or dive right into
...
in URLs, like .php or .asp .
 ...
 To design URLs for an app, you create a Python module called a URLconf . A table of contents for your app, it contains a mapping
...
and renders the template with the retrieved data. Here’s an example view for
 ...
 This example uses Django’s template system , which
...
check for templates with DIRS . If a template
...
object in the given format (as found in PHP’s date function).
 ...
 custom template filters . You can
write custom template tags , which run
...
features:
 ...
 A caching framework that integrates with memcached
or other backends.

 A syndication framework that lets you
